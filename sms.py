...
listsdt = ["086884184", "0328774559", "84328774559", "328774559", "+84328774559","","+84964196194"]
# [ Format Print & Input,.. ]
blue = Col.light_blue
...
def Banner():
    ...
    title = "\n\n\n 𝙏𝙊𝙊𝙇 𝙎𝙋𝘼𝙈 𝙎𝙈𝙎 𝘽𝙔 𝙉𝙂𝙐𝙔𝙀𝙉 𝙏𝙃𝘼𝙉𝙃 𝙋𝙃𝙐𝘾 "
    banner ="""
⚜️Copyright: Nguyen Thanh Phuc - Florence
🔱Telegram: AwmxBaby
📛Instagram: _ng.th.phuc
🔰Email: ngthphuc@hotmail.com
███████████████████████████
███████▀▀▀░░░░░░░▀▀▀███████
████▀░░░░░░░░░░░░░░░░░▀████
███│░░░░░░░░░░░░░░░░░░░│███
...
def oldpops(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "POPS: THẤT BẠI!"))
...
def oldalfrescos(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "ALFRESCOS: THẤT BẠI!"))
...
def ahamove(phone):
    ...
    if Response.status_code == 200:
        ...
        print(format_print("❌", "AHAMOVE: THẤT BẠI!"))
...
def fptplay(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "FPTPLAY: THẤT BẠI!"))
...
def funring(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "FUNRING: THẤT BẠI!"))
...
def moneydong(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "MONEYDONG: THẤT BẠI!"))
...
def daihocfpt(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "DAIHOCFPT: THẤT BẠI!"))
...
def cafeland(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "CAFELAND: THẤT BẠI!"))
...
def oldsenmo(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "SENMO: THẤT BẠI!"))
...
def thantaioi(phone):
    ...
    if response.status_code == 200:
        ...
        print(format_print("❌", "THANTAIOI: THẤT BẠI!"))
...
def Main():
    ...
    while True:
        ...
        if phone in listsdt:
            print(format_print("⁉", "SỐ ADMIN, SPAM ĂN CẶC À?")); exit()
        else:
            if len(phone) == 10:
                break
            else:
                print(format_print("!", "ĐỊT MẸ MÀY, BIẾT SỐ ĐIỆN THOẠI LÀ GÌ KHÔNG ?"))
    while True:
        oldvayvnd(phone)
        oldpops(phone)
        oldtv360(phone)
